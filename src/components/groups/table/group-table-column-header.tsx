...
interface GroupTableColumnHeaderProps extends React.HTMLAttributes<HTMLDivElement> {
  column: Column<SelectGroup, any>
  title: string
}

export function GroupTableColumnHeader({ column, title, className }: GroupTableColumnHeaderProps) {
