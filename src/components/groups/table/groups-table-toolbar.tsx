            ...
            <AlertDialogContent>
              <Form {...deleteAllForm}>
                ...
                >
                  ...
                  />
                  <AlertDialogHeader>
                    <AlertDialogTitle>Confirm Deletion of Group(s)</AlertDialogTitle>
                    <AlertDialogDescription>
                      Are you sure you want to delete the selected group(s)? This action cannot be
                      undone, and all selected groups will be permanently removed.
                    </AlertDialogDescription>
                  </AlertDialogHeader>
                  <AlertDialogFooter>
