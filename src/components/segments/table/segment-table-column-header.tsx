...
interface SegmentTableColumnHeaderProps extends React.HTMLAttributes<HTMLDivElement> {
  column: Column<SelectFilter, any>
  title: string
}

export function SegmentTableColumnHeader({
  column,
  title,
  className,
}: SegmentTableColumnHeaderProps) {
